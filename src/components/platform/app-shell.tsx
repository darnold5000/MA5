...
const MOBILE_TAB = [
  { href: "/app", label: "Home", match: "exact" as const, icon: "home" },
  {
    href: "/app/schedule",
    label: "Reserve",
        ...
        <header className="sticky top-0 z-50 border-b border-border bg-background/95 backdrop-blur">
          <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-3 py-2.5 sm:px-6 sm:py-3 lg:px-8">
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              {/* Theme stays desktop-only in the header; mobile uses the menu. */}
          ...
          {menuOpen ? (
            <>
              ...
              <div
                id="app-mobile-menu"
                className="absolute inset-x-0 top-full z-50 max-h-[calc(100dvh-4rem)] overflow-y-auto border-b border-border bg-surface shadow-lg lg:hidden"
              >
                  ...
                  {SIDEBAR.map((item) => {
                    ...
                    return (
                      <AppNavLink
                        ...
                        href={item.href}
                        className={cn(
                          "flex min-h-12 items-center justify-between gap-2 px-3 text-sm tracking-wide touch-manipulation active:bg-brand/10",
                          active

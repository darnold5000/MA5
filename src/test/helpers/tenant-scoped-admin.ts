...
export type TenantScopedTableData = {
  leads?: Row[];
  visitorSessions?: Row[];
  profiles?: Row[];
};
...
/** Minimal Supabase admin mock that enforces tenant_id filters. */
export function createTenantScopedAdmin(tables: TenantScopedTableData) {
